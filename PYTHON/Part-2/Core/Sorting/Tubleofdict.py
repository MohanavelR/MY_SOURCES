...
print("Index name based :")
print("Sort users :",tuple(sorted(users,key= lambda a:a['fname'])))
print("Index age based :")
print("Sort users :",tuple(sorted(users,key= lambda a:a['age'])))
print("Index city based :")
print("Sort users :",tuple(sorted(users,key= lambda a:a['city'])))
print("Index salary based :")
print("Sort users :",tuple(sorted(users,key= lambda a:["salary"])))
